...
// ignore: unused_element
  _GetCastCalled getCastCalled(int movieId) {
...
mixin _$CastsEvent {
  ...
  Result when<Result extends Object>({
    @required Result getCastCalled(int movieId),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result getCastCalled(int movieId),
...
class _$_GetCastCalled implements _GetCastCalled {
  const _$_GetCastCalled(this.movieId) : assert(movieId != null);
  ...
  @override
  String toString() {
    return 'CastsEvent.getCastCalled(movieId: $movieId)';
  }
...
abstract class _GetCastCalled implements CastsEvent {
  const factory _GetCastCalled(int movieId) = _$_GetCastCalled;
